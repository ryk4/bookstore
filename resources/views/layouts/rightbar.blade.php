                    ...
                    <ul class="list-inline mb-0">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <a class="px-3" href="{{ route('register') }}">Register <span
                            ...
                            <li class="list-inline-item mr-0">
                                <div class="dropdown xp-userprofile">
                                    <a class="dropdown-toggle user-profile-img" href="#" role="button"
                                       ...
                                       aria-expanded="false"><img src="/assets/images/topbar/user.jpg"
                                                                  alt="user-profile"
                                                                  class="rounded-circle img-fluid"><span
                                            class="xp-user-live"></span></a>
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="xp-userprofile">
                                        <div class="dropdown-item">Welcome, {{Auth::user()->name}}</div>
                                        <a class="dropdown-item" href="{{ route('user.settings.index') }}"><i
                                                class="mdi mdi-settings mr-2"></i> User Settings</a>
                                        <a class="dropdown-item" href="{{ route('user.api-settings.index') }}"><i
                                                class="mdi mdi-cellphone-key mr-2"></i> API Settings</a>
